...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("canHurry", &CyCity::canHurry, "bool (int (HurryTypes) eHurry, bool bTestVisible) - can player eHurry in this city?")
		.def("hurry", &CyCity::hurry, "void (int (HurryTypes) eHurry) - forces the city to rush production using eHurry")
