...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("setVictoryValid", &CyGame::setVictoryValid, "void (int VictoryType, bool bValid")
		...
		.def("getScriptData", &CyGame::getScriptData, "string () - Returns ScriptData member (used to store custom data)")
		...
		.def("getReplayMessageText", &CyGame::getReplayMessageText, "wstring (int i) (int i)")
